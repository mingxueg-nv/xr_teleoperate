...
class EpisodeWriter:
    ...
    def set_ee_metadata(
        self,
        left_joint_names=None,
        right_joint_names=None,
        left_tactile_names=None,
        right_tactile_names=None,
        body_joint_names=None,
    ):
        """Populate end-effector / body joint / tactile names in info before recording starts."""
        ...
        if body_joint_names is not None:
            self.info["joint_names"]["body"] = list(body_joint_names)
